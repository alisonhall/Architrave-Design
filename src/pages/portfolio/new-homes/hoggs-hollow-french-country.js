...
const ContactUs = () => (
  <Layout mainClasses="portfolio hoggsHollowFrenchCountry">
    ...
    <section class="contentWrapper layoutAll layoutNewHomesHoggsHollowFrenchCountry">
      ...
      <a href="/portfolio/new-homes/oakville-executive-home" class="prevProject"><i class="fa fa-arrow-left"></i><span>Previous Project</span></a>
      <a href="/portfolio/new-homes/kingsway-traditional" class="nextProject"><span>Next Project</span><i class="fa fa-arrow-right"></i></a>
    </section>
  </Layout>
)
