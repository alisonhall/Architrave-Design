...
const ContactUs = () => (
  <Layout mainClasses="portfolio kingswayTraditional">
    ...
    <section class="contentWrapper layoutAll layoutNewHomesKingswayTraditional">
      ...
      <a href="/portfolio/new-homes/hoggs-hollow-french-country.html" class="prevProject"><i class="fa fa-arrow-left"></i><span>Previous Project</span></a>
      <a href="/portfolio/new-homes/hoggs-hollow-traditional.html" class="nextProject"><span>Next Project</span><i class="fa fa-arrow-right"></i></a>
    </section>
  </Layout>
)
