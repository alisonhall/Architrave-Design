...
const ContactUs = () => (
  <Layout mainClasses="portfolio cornwallHeritageAddition">
    ...
    <section class="contentWrapper layoutAll layoutRenovationsCornwallHeritageAddition">
      ...
      <a href="/portfolio/renovations-additions/etobicoke-renewal.html" class="prevProject"><i class="fa fa-arrow-left"></i><span>Previous Project</span></a>
      <a href="/portfolio/renovations-additions/rosedale-revival.html" class="nextProject"><span>Next Project</span><i class="fa fa-arrow-right"></i></a>
    </section>
  </Layout>
)
